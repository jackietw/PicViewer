...
namespace PicViewer
{
    ...
    public static class LanguageManager
    {
        ...
        private static readonly Dictionary<string, string> DefaultEnglishStrings = new Dictionary<string, string>
        {
            ...
            { "Menu_FilterSettings", "Preferences..." },
            ...
            { "Msg_Error", "Error" },
            { "Title_FilterWindow", "Preferences" },
            { "Group_Filter", "Display Filters" },
            { "Group_Misc", "Misc" },
            { "Misc_ShowExif", "Show EXIF Information" },
            { "Group_Association", "System Integration" },
            { "Assoc_Prompt", "Set PicViewer as the default Windows image viewer (Applies immediately)" },
            { "Filter_Prompt", "Select the file formats to display in folders:" },
            ...
            { "Msg_Associated", "Status: Associated" },
            { "Msg_NotAssociated", "Status: Not Associated" },
